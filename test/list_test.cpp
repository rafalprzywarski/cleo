...
{
    Root list{Force(create_list(nullptr, 0))};
...
TEST_F(list_test, should_create_a_list_from_elements)
{
    ...
    Root list{force(create_list(&*elem, 1))};
...
{
    Root list0{force(create_list(nullptr, 0))};
    Root elem0, elem1, elem2, next;
    *elem0 = create_int64(101);
    *elem1 = create_int64(102);
    *elem2 = create_int64(103);
    Root list1{force(list_conj(*list0, *elem0))};
    Root list2{force(list_conj(*list1, *elem1))};
    Root list3{force(list_conj(*list2, *elem2))};
    ...
    *next = get_list_next(*list2);
    ...
    ASSERT_TRUE(nil == get_list_next(*next));
