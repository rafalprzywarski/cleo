...
TEST_F(macro_test, macroexpand1_should_eval_the_body_OLD)
{
    Root v{array(5, 6, 7)};
    Root seq{list(SEQ, *v)};
...
TEST_F(macro_test, macroexpand1_should_pass_the_arguments_unevaluated_OLD)
{
...
TEST_F(macro_test, macroexpand1_should_evaluate_the_first_argument_if_its_a_symbol_OLD)
{
    auto a = create_symbol("a");
    auto b = create_symbol("b");
    auto c = create_symbol("c");
...
TEST_F(macro_test, macroexpand1_should_fail_on_wrong_number_of_args_OLD)
{
    auto a = create_symbol("a");
    auto b = create_symbol("b");
    auto c = create_symbol("c");
...
TEST_F(macro_test, macroexpand_expand_until_the_first_element_is_not_a_macro_OLD)
{
    Root params{array()};
...
TEST_F(macro_test, eval_should_expand_the_macro_and_eval_the_result_OLD)
{
...
TEST_F(macro_test, should_correctly_resolve_symbols_from_macros_namespace_OLD)
{
    in_ns(create_symbol("cleo.macro.resolve.test1"));
    define(create_symbol("cleo.macro.resolve.test1", "x"), create_keyword("ok"));
...
TEST_F(macro_test, should_pass_the_form_as_a_hidden_parameter_OLD)
{
...
TEST_F(macro_test, should_pass_the_env_as_a_hidden_parameter_OLD)
{
